<template>
  <section class="feature">
    <div class="container">
      <div class="row">
        <div class="col-lg-4 text-lg-left text-md-center text-left mb-lg-0 mb-sm-5 mb-5">
          <FeatherIcon class="feature-icon" />
          <div class="feature-title">Optimized Website</div>
          <p class="feature-body mx-lg-0 mx-md-auto">
        ...
        <div class="col-lg-4 text-lg-left text-md-center text-left mb-lg-0 mb-sm-5 mb-0"> <!-- LAST CHILD -->
